...
// A: Pos-ordem é a melhor ordem para aqui, pois é a melhor maneira de destruir a árvore removendo primeiro os nós
// mais distantes (primeiro os da esquerda e de seguida os da direita) e só depois a raiz
...
// A: Sim, pois estamos a criar uma Queue desde o menor ao maior 
